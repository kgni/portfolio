	...
	return (
		<>
			...
			<Page id="about" styles="">
				{isMobile ? (
					<>
						<h2 className="mb-16 text-8xl font-bold text-offwhite">ABOUT</h2>
						<div className="profile-card w-full rounded-lg bg-[#FFFAFA] p-8">
							...
							<div className="skills">
								...
								<motion.div
									...
									viewport={{ once: true }}
									className="mb-4 h-1 w-full bg-primary"
								></motion.div>
								<div className="mb-4 flex items-center justify-between">
									...
									{/* React */}
									<Tippy content="React" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
							...
							/> */}
								...
								<div className="flex items-center justify-between ">
									...
									<Tippy content="Node.js" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
									...
									{/* MONGO */}
									<Tippy content="MongoDB" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
									...
									<Tippy content="Express" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
									...
									{/* Next.js */}
									<Tippy content="Next.js" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
									...
									<Tippy content="GraphQL" placement="bottom" theme="material">
										<motion.img
											whileHover={{ scale: 1.05 }}
							...
							<div className="w-3/6 text-xl leading-8">
								<div className="mb-14">
									...
									<p className="mb-2">
										...
										living in Spain <Flag className="inline w-4" code={'ES'} />.
									</p>
									<p className="mb-2">
								...
								<div className="skills">
									...
									></motion.div>
									<div className="grid grid-cols-6 place-items-center items-center gap-x-4 gap-y-4 ">
										{/* HTML */}
